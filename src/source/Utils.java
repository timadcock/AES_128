...
public class Utils {
     ...
     */
    public static final int[] INVERSESUBBYTE = {0x52, 0x09, 0x6A, 0xD5, 0x30,
    ...
    public static StringBuilder read_file(String input_file) {
        ...
        try {
            br = new BufferedReader(new FileReader(String.valueOf(input_file)));
    ...
    public static void write_to_file(String data, String output_file) {
        ...
        FileWriter br = null;
        try {
            br = new FileWriter(String.valueOf(output_file));
            StringBuilder sb = new StringBuilder();
            br.write(data);
